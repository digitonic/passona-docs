...
const resources = [
  ...
  },
  {
    ...
    name: 'Campaigns',
    description:
        'Campaigns are used to send SMS\'s to groups of recipients known as contact groups in Passona.',
    icon: EnvelopeIcon,
    pattern: {
      y: 32,
      squares: [
...

  {
    ...
    name: 'Templates',
    description:
      'Templates are the make up of the content that will be delivered to the end recipients handset.',
    icon: ShapesIcon,
    pattern: {
      y: 22,
      squares: [[0, 1]],
